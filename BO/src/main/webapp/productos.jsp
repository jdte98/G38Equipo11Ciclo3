        ...
        <div class="container estilocontainer" align="center">
          <div class="container estilocontainer" align="center">
            ...
            <div class="row">
              ...
              <div id="mensaje-error-archivo" class="alert errormensaje visually-hidden" role="alert">
            ...
            <div class="row">
              <div class="col-3"></div>
              <div class="col">
                <!--Caja para subir archivo CSV-->
                <input id="archivo" class="form-control file" type="file" />
              </div>
              <div class="col-3"></div>
            </div>
            <br />
            <div class="row align-middle">
              ...
              <div class="col-2 d-grid">
                <button class="btn botonnormal" type="button" onclick="subirArchivo()">
            ...
            <br>
            <div id="tablaProductos" class="row align-middle visually-hidden">
