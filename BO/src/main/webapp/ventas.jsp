				...
				<div class="row justify-content-center">
					...
					<div class="col-4 align-self-center">
						...
						<div class="row d-grid">
							...
							<button class="btn botonnormal" type="button"
								onclick="window.location.href='registrar_ventas.jsp'">Registrar</button>
						</div>
						<br>
						<div class="row d-grid">
						...
						<br>
						<div class="row d-grid">
							<!--Boton Lista de ventas-->
							<button class="btn botonnormal" type="button"
								onclick="window.location.href='lista_venta.jsp'">Lista de Ventas</button>
						</div>
					</div>
					<div class="col-1"></div>
					<!--Caja vacia para centrar el titulo-->
