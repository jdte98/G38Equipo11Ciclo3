...
<title>E11 - Crear proveedor</title>
...
<body class="fondo m-2">
		...
		<div class="container-fluid cont">
			<div class="container estilocontainer" align="center">
				<div class="row align-items-center align-middle">
					...
					<div class="col">
						<a class="flecha-volver" href="proveedores.jsp"> <i
				...
				<div class="row">
					<!--Mensajes de alerta-->
					<div id="errorcrearproveedor"
						class="alert errormensaje visually-hidden" role="alert">
						<span><i class="fas fa-user-times fa-2x"></i></span> El proveedor no
						se ha podido crear
					</div>
					<div id="correctocrearproveedor"
						class="alert mensaje-bien visually-hidden" role="alert">
						<span><i class="fas fa-user-check fa-2x"></i></span> El proveedor
				...
				<form action="">
					<div class="row">
						...
						<div class="col">
							...
							<input id="nit_proveedor" type="text"
								class="form-control shadow-sm cajatexto"
					...
					<div class="row">
						...
						<div class="col">
							<!--Caja texto CÃ©dula-->
							<input id="ciudad_proveedor" type="text"
								class="form-control shadow-sm cajatexto" placeholder="Ciudad"
								required>
						</div>
						<div class="col-3"></div>
					</div>
					...
					<div class="row">
						...
						<div class="col">
							...
							<input id="direccion_proveedor" type="text"
								class="form-control shadow-sm cajatexto" placeholder="Dirección"
								required>
						</div>
						<div class="col-3"></div>
					</div>
					...
					<div class="row">
						...
						<div class="col">
							...
							<input id="nombre_proveedor" type="text"
								class="form-control shadow-sm cajatexto" placeholder="Nombre"
								required>
						</div>
						<div class="col-3"></div>
					</div>
					...
					<div class="row">
						...
						<div class="col">
							<!--Caja texto Telefono-->
							<input id="telefono_proveedor" type="tel"
								class="form-control shadow-sm cajatexto" placeholder="Teléfono"
								required>
						</div>
						<div class="col-3"></div>
					</div>
	...
	<script src="script_proveedor_crear.js"></script>
</body>
